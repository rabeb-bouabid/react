  ...
  <div className="main-panel">
          ...
          <div className="card">
            <div className="card-body"><div className="chartjs-size-monitor"><div className="chartjs-size-monitor-expand"><div className /></div><div className="chartjs-size-monitor-shrink"><div className /></div></div>
              <div className="clearfix">
                ...
                <div id="visit-sale-chart-legend" className="rounded-legend legend-horizontal legend-top-right float-right"><ul><li><span className="legend-dots" style={{background: 'linear-gradient(to right, rgba(218, 140, 255, 1), rgba(154, 85, 255, 1))'}} />CHN</li><li><span className="legend-dots" style={{background: 'linear-gradient(to right, rgba(255, 191, 150, 1), rgba(254, 112, 150, 1))'}} />USA</li><li><span className="legend-dots" style={{background: 'linear-gradient(to right, rgba(54, 215, 232, 1), rgba(177, 148, 250, 1))'}} />UK</li></ul></div>
              </div>
              <canvas id="visit-sale-chart" className="mt-4 chartjs-render-monitor" style={{display: 'block', height: 175, width: 350}} width={437} height={218} />
            </div>
          </div>
        </div>
        <div className="col-md-5 grid-margin stretch-card">
          <div className="card">
            <div className="card-body"><div className="chartjs-size-monitor"><div className="chartjs-size-monitor-expand"><div className /></div><div className="chartjs-size-monitor-shrink"><div className /></div></div>
              ...
              <canvas id="traffic-chart" width={270} height={135} style={{display: 'block', height: 108, width: 216}} className="chartjs-render-monitor" />
              <div id="traffic-chart-legend" className="rounded-legend legend-vertical legend-bottom-left pt-4"><ul><li><span className="legend-dots" style={{background: 'linear-gradient(to right, rgba(54, 215, 232, 1), rgba(177, 148, 250, 1))'}} />Search Engines<span className="float-right">30%</span></li><li><span className="legend-dots" style={{background: 'linear-gradient(to right, rgba(6, 185, 157, 1), rgba(132, 217, 210, 1))'}} />Direct Click<span className="float-right">30%</span></li><li><span className="legend-dots" style={{background: 'linear-gradient(to right, rgba(255, 191, 150, 1), rgba(254, 112, 150, 1))'}} />Bookmarks Click<span className="float-right">40%</span></li></ul></div>
            </div>
          </div>
        </div>
      </div>
              ...
              <div className="list-wrapper">
                <ul className="d-flex flex-column-reverse todo-list todo-list-custom">
                  <li>
                    <div className="form-check">
                      <label className="form-check-label">
                        <input className="checkbox" type="checkbox" /> Meeting with Alisa <i className="input-helper" /></label>
                    </div>
                  ...
                  <li className="completed">
                    <div className="form-check">
                      <label className="form-check-label">
                        <input className="checkbox" type="checkbox" defaultChecked /> Call John <i className="input-helper" /></label>
                    </div>
                    <i className="remove mdi mdi-close-circle-outline" />
                  </li>
                  <li>
                  ...
                  <li>
                    <div className="form-check">
                      <label className="form-check-label">
                        <input className="checkbox" type="checkbox" /> Print Statements <i className="input-helper" /></label>
                    </div>
                    <i className="remove mdi mdi-close-circle-outline" />
                  </li>
                  <li className="completed">
    ...
    <footer className="footer">
      <div className="container-fluid clearfix">
        ...
        <span className="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"> Free <a href="https://wordpress-923989-3206731.cloudwaysapps.com/bootstrap-admin-template/" target="_blank">Bootstrap admin template</a> from Bootstrapdash.com</span>
      </div>
    </footer>
    {/* partial */}
  </div>
